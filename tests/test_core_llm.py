...
async def test_checkpoint_title_generation():
    ...
    try:
        chat = LlmChat(
            ...
            system_message="""You are a navigation assistant for Chandni Chowk, Delhi. 
        ...
        msg = UserMessage(
            text="""Trainer description: "After exiting metro gate 5, walk straight about 50 meters. 
        ...
        print("✅ TEST 1 PASSED: Checkpoint title generation works")
        return True
...
async def test_instruction_improvement():
    ...
    try:
        chat = LlmChat(
            ...
            system_message="""You are a navigation instruction editor for a Chandni Chowk navigation app.
        ...
        msg = UserMessage(
            text="""Original trainer instruction: "go thru the narrow gali after the paan shop, 
        ...
        print("✅ TEST 2 PASSED: Instruction improvement works")
        return True
    except Exception as e:
...
async def test_route_summary_generation():
    ...
    try:
        chat = LlmChat(
            ...
            system_message="""You are a navigation assistant that creates brief route summaries.
        ...
        msg = UserMessage(
            text="""Route: "Metro Gate 5 to Yash Complex"
            Checkpoints:
            1. Metro Gate 5 Exit
        ...
        assert len(response) > 20, "Response too short"
        print("✅ TEST 3 PASSED: Route summary generation works")
        return True
    except Exception as e:
...
async def test_warning_generation():
    ...
    try:
        chat = LlmChat(
            ...
            system_message="""You are a navigation safety assistant for Chandni Chowk.
        ...
        msg = UserMessage(
            text="""Confusion point: "After entering the narrow lane, there are TWO similar-looking 
        ...
        assert len(response) > 20, "Response too short"
        print("✅ TEST 4 PASSED: Warning generation works")
        return True
    except Exception as e:
